...
activities = {
    ...
    "Soccer Team": {
        "description": "Practice teamwork, ball handling, and match strategy",
        "schedule": "Wednesdays and Fridays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["liam@mergington.edu", "noah@mergington.edu"]
    },
    "Basketball Club": {
        "description": "Improve shooting, defense, and game play in a competitive setting",
    ...
    "Math Olympiad": {
        ...
        "max_participants": 10,
        "participants": ["james@mergington.edu", "henry@mergington.edu"]
    },
    "Debate Club": {
